...
class StaticPage extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'studiobosco.seoextension::lang.component.static.name',
            'description' => 'studiobosco.seoextension::lang.component.static.description'
        ];
    }
    ...
    public function onRun()
    {
        ...
        if (class_exists('Winter\Translate\Behaviors\TranslatableModel') && \Winter\Translate\Models\Locale::isAvailable())
            $url = substr($url, 3);
        ...
        if ($this->page) {
            ...
            $this->seo_title = $this->page['seo_title'] = $this->page->getViewBag()->property('seo_title', $this->page->getViewBag()->property('meta_title'));
            $this->title = $this->page['title'] = $this->page->getViewBag()->property('title');
            $this->seo_description = $this->page['seo_description'] = $this->page->getViewBag()->property('seo_description', $this->page->getViewBag()->property('meta_description'));
